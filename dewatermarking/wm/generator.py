...
class Generator():
    ...
    def top_p(self, logits, temperature, top_p):
        ...
        next_token_probs = torch.zeros(logits.shape, dtype=torch.bfloat16, device=logits.device).scatter_(-1, probs_idx, probs_sort) # probability of next token, ordered by vocab 
